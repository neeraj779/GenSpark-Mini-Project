            ...
            modelBuilder.Entity("StudentManagementAPI.Models.DBModels.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 100,
                            Password = new byte[] { 26, 220, 122, 133, 151, 198, 222, 56, 243, 177, 120, 180, 13, 123, 58, 7, 98, 122, 119, 252, 61, 74, 192, 68, 129, 68, 125, 197, 216, 99, 190, 48, 127, 69, 18, 108, 243, 208, 27, 59, 59, 68, 200, 84, 101, 105, 63, 155, 166, 18, 17, 222, 77, 251, 0, 47, 112, 73, 45, 228, 218, 79, 18, 239 },
                            PasswordHashKey = new byte[] { 198, 90, 132, 88, 220, 42, 242, 68, 66, 203, 177, 227, 147, 176, 252, 217, 241, 138, 66, 173, 93, 37, 182, 253, 242, 13, 42, 227, 176, 197, 3, 10, 15, 47, 41, 195, 21, 16, 230, 137, 249, 38, 239, 104, 212, 227, 140, 223, 59, 80, 105, 255, 149, 40, 206, 155, 175, 135, 63, 51, 117, 211, 50, 225, 73, 135, 246, 108, 22, 65, 254, 38, 115, 212, 11, 157, 147, 71, 123, 225, 186, 133, 71, 44, 166, 197, 175, 78, 216, 229, 180, 152, 141, 99, 158, 65, 136, 6, 138, 111, 200, 74, 63, 176, 184, 235, 166, 88, 15, 245, 60, 242, 138, 95, 156, 200, 229, 17, 98, 183, 242, 79, 127, 118, 228, 60, 88, 109 },
                            RegistrationDate = new DateTime(2024, 5, 30, 4, 59, 1, 1, DateTimeKind.Utc).AddTicks(2192),
                            Role = 0,
                            Status = "Active",
                            UserName = "admin"
                        });
