...
namespace StudentManagementAPI.Migrations
{
    ...
    [Migration("20240602091231_initial")]
            ...
            modelBuilder.Entity("StudentManagementAPI.Models.DBModels.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 100,
                            Password = new byte[] { 81, 204, 149, 198, 203, 110, 12, 64, 109, 48, 230, 205, 252, 251, 246, 252, 69, 174, 183, 227, 103, 29, 181, 251, 88, 76, 150, 41, 70, 112, 179, 104, 27, 0, 61, 129, 252, 234, 20, 115, 179, 83, 52, 31, 148, 59, 207, 233, 115, 24, 232, 143, 253, 191, 178, 29, 90, 156, 40, 99, 230, 183, 62, 85 },
                            PasswordHashKey = new byte[] { 165, 33, 38, 22, 186, 148, 210, 159, 152, 119, 33, 225, 60, 97, 79, 22, 90, 68, 26, 246, 184, 195, 29, 100, 126, 81, 202, 212, 167, 192, 115, 125, 107, 134, 132, 154, 237, 46, 188, 244, 145, 158, 200, 6, 16, 255, 107, 72, 181, 123, 80, 253, 57, 92, 109, 248, 240, 248, 15, 10, 87, 37, 44, 165, 49, 188, 51, 230, 75, 210, 48, 104, 48, 81, 131, 62, 86, 247, 36, 149, 205, 208, 97, 201, 29, 73, 60, 239, 52, 8, 143, 227, 52, 167, 115, 91, 147, 154, 201, 126, 229, 126, 13, 36, 157, 7, 81, 219, 244, 167, 30, 29, 181, 22, 222, 122, 196, 57, 49, 55, 242, 118, 143, 144, 0, 60, 210, 204 },
                            RegistrationDate = new DateTime(2024, 6, 2, 9, 12, 30, 778, DateTimeKind.Utc).AddTicks(5155),
                            Role = 0,
                            Status = "Active",
                            UserName = "admin"
                        });
